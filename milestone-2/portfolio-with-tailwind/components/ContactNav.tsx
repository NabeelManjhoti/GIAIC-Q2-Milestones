...
const ContactNav = () => {
    return (
        <nav className="w-full flex justify-center md:justify-end pt-3 md:pr-8">
            <div className="h-[100px] w-[403px] sm:w-[603px] md:w-[503px] bg-background rounded-2xl drop-shadow-md">
                <ul className="flex pt-[10px] justify-evenly">
                    ...
                    <li
                        className={`${raleway} h-[80px] w-[80px] bg-iconsBg text-iconsColor text-opacity-50 hover:bg-linear hover:text-navFont rounded-2xl font-semibold text-[12px]`}
                    >
                        <Link
                            className="w-full h-full flex flex-col items-center justify-center"
                            href={"/resume"}
                    ...
                    <li
                        className={`${raleway} h-[80px] w-[80px] bg-iconsBg text-iconsColor text-opacity-50 hover:bg-linear hover:text-navFont Font rounded-2xl font-semibold text-[12px]`}
                    >
                        <Link
                            className="w-full h-full flex flex-col items-center justify-center"
                            href={"/work"}
